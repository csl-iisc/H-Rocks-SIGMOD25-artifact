...
( cd "$PM" && SIZES="$SIZES" ./pmem_parse_deletes.sh output_deletes "$OUT/pmem_deletes.csv" )
( cd "$VP" && SIZES="$SIZES" ./viper_parse_deletes.sh output_deletes "$OUT/viper_deletes.csv" )
( cd "$PL" && SIZES="$SIZES" ./plush_parse_deletes.sh . "$OUT/plush_deletes.csv" )
