...
SIZES="${SIZES:-}"
( cd "$HR" && SIZES="$SIZES" ./parse_ycsbD_min.sh . "$OUT/hrocks_ycsbD.csv" )
( cd "$PM" && SIZES="$SIZES" ./pmem_parse_ycsbD_min.sh output_ycsbD "$OUT/pmem_ycsbD.csv" )
( cd "$VP" && SIZES="$SIZES" ./viper_parse_ycsbD_min.sh output_ycsbD "$OUT/viper_ycsbD.csv" )
( cd "$PL" && SIZES="$SIZES" ./plush_parse_ycsbD_min.sh . "$OUT/plush_ycsbD.csv" )
