...
BASE_DIR="/home/shweta/pkvs/viper/benchmark"
...
mkdir -p "/home/shweta/pkvs/viper"
cd "/home/shweta/pkvs/viper/YCSB"

echo "GENERATING PREFILL DATA"
./bin/ycsb.sh load basic -P ${PREFILL_CONF} -s > "${DATA_DIR}/raw_prefill.dat"

echo "GENERATING YCSB DATA"
for config in "${CONFIGS[@]}"
do
  echo "GENERATING ${config}..."
  ./bin/ycsb.sh run basic -P ${PREFILL_CONF} \
