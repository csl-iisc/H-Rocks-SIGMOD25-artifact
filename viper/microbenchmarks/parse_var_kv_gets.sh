#!/usr/bin/env bash
# Usage:
#   ./viper_parse_var_kv_gets.sh [INPUT_DIR] [OUTPUT_CSV]
# Example:
#   ./viper_parse_var_kv_gets.sh output_var_kv_gets viper_var_kv_gets.csv
# Optional filters (env):
#   SIZES="1000000 5000000" KEYS="8 16" VALS="8 32 128" ./viper_parse_var_kv_gets.sh
set -euo pipefail
