...
# Usage:
#   ./viper_parse_ycsbB.sh [INPUT_DIR] [OUTPUT_CSV]
# Example:
#   ./viper_parse_ycsbB.sh output_ycsbB viper_ycsbB_throughput.csv
# Optional:
#   SIZES="100000 200000" ./viper_parse_ycsbB.sh output_ycsbB viper_ycsbB_throughput.csv
