...
int main(int argc, char **argv) {
...

    {
        ...
        Hashtable<std::span<const std::byte>, std::span<const std::byte>, PartitionType::Hash> table("/pmem/tabletest", true);
...

    {
        ...
        Hashtable<std::span<const std::byte>, std::span<const std::byte>, PartitionType::Hash> table("/pmem/tabletest", false);
        std::string key = "Das Lied von der Glocke";
